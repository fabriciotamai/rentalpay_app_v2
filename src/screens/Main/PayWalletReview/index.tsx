...
export function PayWalletReview() {
          ...
          <ScrollContent>
            ...
            <DataContent>
              ...
              <IdentifierContent>
                ...
                <IdentifierValue>Wallet Cripto</IdentifierValue>
              </IdentifierContent>
              <IdentifierContent>
                <IdentifierText>Moeda</IdentifierText>
                <IdentifierValue>Bitcoin - BTC</IdentifierValue>
              </IdentifierContent>
              <PayMethodContent>
                <PayMethodText>Cotação</PayMethodText>
                <PayMethodValue>8.92</PayMethodValue>
              </PayMethodContent>
            </DataContent>
