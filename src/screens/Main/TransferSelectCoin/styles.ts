...
export const OptionContent = styled.TouchableOpacity<OptionProps>`
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
  margin-top: ${RFValue(24)}px;
  ...
  ${({isActive}) =>
    ...
    !isActive &&
    css`
      background-color: ${RFValue(12)}px;
    `} */
`;
...
export const OptionItemButton = styled.TouchableOpacity<ButtonSelect>``;

export const OptionItem = styled.Text<ButtonSelect>`
